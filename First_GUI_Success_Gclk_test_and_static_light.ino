...
//      tlc.set_pixel_16bit_value(17, 0,0,0);
  ...
  void staticRed() { //If button is pressed in GUI
       ...
       for (int i = 0 ; i < cells ; i++) {
         tlc.set_pixel_16bit_value(12 + 24 * i, 5000, 0, 0); // R G B Red full
         tlc.set_pixel_16bit_value(13 + 24* i, 15000, 0, 0); 
         tlc.set_pixel_16bit_value(14 + 24* i, 20000, 0, 0); 
         tlc.set_pixel_16bit_value(15 + 24 * i, 25000, 0, 0); 
         tlc.set_pixel_16bit_value(16 + 24* i, 30000, 0, 0); 
         tlc.set_pixel_16bit_value(17 + 24 * i, 35000, 0, 0); 
         tlc.set_pixel_16bit_value(18 + 24* i, 40000, 0, 0); 
         tlc.set_pixel_16bit_value(19 + 24 * i, 45000, 0, 0); 
         tlc.set_pixel_16bit_value(20 + 24* i, 50000, 0, 0); 
         tlc.set_pixel_16bit_value(21 + 24 * i, 55000, 0, 0); 
         tlc.set_pixel_16bit_value(22 + 24 * i, 60000, 0, 0); 
  ...
  void staticBlue() {
         int cells = 8; // discovery 4/28/23 so for green we want 1-11, 24-35, 48-59, etc. 
       for (int i = 0 ; i < cells ; i++) {
         tlc.set_pixel_16bit_value(12 + 24 * i, 0, 0, 5000); // R G B Blue full
         tlc.set_pixel_16bit_value(13 + 24* i, 0, 0, 15000); 
         tlc.set_pixel_16bit_value(14 + 24* i, 0, 0, 20000); 
         tlc.set_pixel_16bit_value(15 + 24 * i, 0, 0, 25000); 
         tlc.set_pixel_16bit_value(16 + 24* i, 0, 0, 30000); 
         tlc.set_pixel_16bit_value(17 + 24 * i, 0, 0, 35000); 
         tlc.set_pixel_16bit_value(18 + 24* i, 0, 0, 40000); 
         tlc.set_pixel_16bit_value(19 + 24 * i, 0, 0, 45000); 
         tlc.set_pixel_16bit_value(20 + 24* i, 0, 0, 50000); 
         tlc.set_pixel_16bit_value(21 + 24 * i, 0, 0, 55000); 
         tlc.set_pixel_16bit_value(22 + 24 * i, 0, 0, 60000); 
  ...
  void staticGreen() {
   ...
   void uv() {
     int cells = 8; // discovery 4/28/23 so for UV we also want 1-11, 24-35, 48-59, etc. 
       for (int i = 0 ; i < cells ; i++) {
         tlc.set_pixel_16bit_value(0 + 24 * i, 5000, 0, 0); // UV full
         tlc.set_pixel_16bit_value(1 + 24* i, 15000, 0, 0); 
         tlc.set_pixel_16bit_value(2 + 24* i, 20000, 0, 0); 
         tlc.set_pixel_16bit_value(3 + 24 * i, 25000, 0, 0); 
         tlc.set_pixel_16bit_value(4 + 24* i, 30000, 0, 0); 
         tlc.set_pixel_16bit_value(5 + 24 * i, 35000, 0, 0); 
         tlc.set_pixel_16bit_value(6 + 24* i, 40000, 0, 0); 
         tlc.set_pixel_16bit_value(7 + 24 * i, 45000, 0, 0); 
         tlc.set_pixel_16bit_value(8 + 24* i, 50000, 0, 0); 
         tlc.set_pixel_16bit_value(9 + 24 * i, 55000, 0, 0); 
         tlc.set_pixel_16bit_value(10 + 24 * i, 60000, 0, 0); 
     ...
     int cells = 8, l=12;  
       for (int i = 0 ; i < cells ; i++) {
        for (l; l<(24+i*24); l++){ //This goes from 12-23 the first time, 36-47, 60-71,84-95 
         tlc.set_pixel_16bit_value(l , 0, 0, value_high); // R G B Blue full    + 24 * i
         tlc.show();
         delay(50);
        }
        l=l+12;
...
//   if ( //pretty sure this is just to display time in the serial port display
